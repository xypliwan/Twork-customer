...
import DynamicReply from './DynamicReply'
import { getActionLog, targetReply } from '@/api/targetOkr'
...
export default {
  ...
  methods: {
    ...
    async getActionLog() {
      ...
      try {
        let { data } = await getActionLog(this.params)
        data.forEach(el => {
