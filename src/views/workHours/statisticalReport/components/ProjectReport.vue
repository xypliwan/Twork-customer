<template>
  <div class="wrap">
    <div class="filterWrap">
      <el-form :inline="true" size="mini" ref="ruleForm">
        <el-form-item label="项目名称:">
          <el-input size="mini" v-model="value" placeholder="请输入项目名称">
            <el-button
              slot="append"
              icon="el-icon-search"
              size="mini"
    ...
    >
      ...
      <el-table-column prop="name" label="项目状态"> </el-table-column>
      <el-table-column prop="address" label="项目周期"> </el-table-column>
      <el-table-column prop="name" label="项目参与人"> </el-table-column>
      <el-table-column prop="address" label="项目总工时"> </el-table-column>
      <el-table-column prop="address" label="项目平均工时"> </el-table-column>
